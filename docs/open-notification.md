...
- 요청한 테스트 발송 시각: **2026-09-26 18:30:00 한국 시간** (`2026-09-26T09:30:00Z`).
...
| `PUSH_OPEN_AT` | `2026-09-26T18:30:00+09:00` |
| `PUSH_OPEN_MODE` | `test` |
...
3. **알림 신청 완료**와 **9월 26일 오후 6:30** 안내를 확인합니다. 버튼만 누르거나 알림 권한만 허용한 상태는 예약 완료가 아닙니다.
4. 사이트를 닫고 기기의 인터넷·알림 허용을 유지합니다.
5. 18:30 이후 테스트 알림을 확인하고 누르면 `/main`이 열리는지 확인합니다.
