...
import splashBackground from '../assets/Landing/starfield-blue.png'
...
export default function Splash({ onComplete }: SplashProps) {
  ...
  useEffect(() => {
    ...
    themeColor?.setAttribute('content', '#05132e')
  ...
  return (
    <div
      data-testid="splash"
      className={`bg-[#05132e] splash fixed top-0 left-1/2 z-100 h-dvh w-[min(100%,var(--app-max-width))] -translate-x-1/2 overflow-hidden transition-opacity ease-out motion-reduce:transition-none ${isExiting ? 'opacity-0' : 'opacity-100'}`}
    ...
    >
      <div className={"absolute inset-[0] overflow-hidden pointer-events-none splash-sky"} aria-hidden="true">
        ...
        <div className="absolute inset-0 bg-linear-to-b from-[#041127]/45 via-transparent to-[#061d48]/20 splash-shade" />
      </div>
